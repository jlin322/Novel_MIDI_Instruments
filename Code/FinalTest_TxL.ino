...
const int S2 = 2;
const int S3 = 1;
const int ROTENC1 = 6;  //Rotary Encoder
const int ROTENC2 = 7;
...
void setup() {
  Serial.begin(9600);
  pinMode(ROTPLATE1, INPUT_PULLUP); //Pull up resistors for rotational plate
...
void loop() {
  ...
  delay(2); //slight delay to prevent multi-Tx data signals from cancelling each other out
}