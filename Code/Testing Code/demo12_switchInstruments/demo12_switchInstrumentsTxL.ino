...
const int S2 = 2;
const int S3 = 1;
const int ROTENC1 = 6;  //either CLK or DT from Rotary Encoder
const int ROTENC2 = 7;
const int ROTPLATE1 = 17;
const int ROTPLATE2 = 18;
const int ROTPLATE3 = 19;
const int SIG = A6; //signal from mux board coming in: 20
const int JOYSTICK = A8;  // A8 is 22
...
void loop() {
  ...
  if(iterate >= 7){
    ...
    Serial.println("Rotary Encoder Val: "+String(dataSigSend.rotEncoder));
